...
public class FornecedorEnderecoDTO {
    ...
    public FornecedorEnderecoDTO(){}

    public FornecedorEnderecoDTO(Long id, String nome, String cpf_cnpj, String phone,
                                 String email, Long idEndereco, String logradouro, String numero,
    ...
    public FornecedorEnderecoDTO(Fornecedor entity) {
